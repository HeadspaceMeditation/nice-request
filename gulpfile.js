...
gulp.task('lint', ['enforce-quality'], () => {
  ...
  return gulp.src([
    'nice-request.js',
    'make-request/**/*.js',
    'nice-request.test.js',
    'nice-request.integration.test.js',
    '!gulpfile.js',
    '!node_modules/**'
    ])
    .pipe(cache('eslint'))
...
gulp.task('lint-watch', ['lint'], () => {
  ...
  return gulp.watch(['nice-request.js', 'make-request/**/*.js', 'nice-request.test.js', 'nice-request.integration.test.js'], ['lint'], (event) => {
